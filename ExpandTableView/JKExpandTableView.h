...
/*!
 @param parentIndex The parent index in question
 @return The id int shown on the parent cell.
 */
...
/*!
 @param childIndex The child index in question
 @param parentIndex The parent index in question
 @return The id int shown on the child cell.
 */
...
/*! Optional method
 ...
 @param parentIndex The parent index in question
 @return UIColor shown to the left of the label for the parent.
 */
...
/*! Optional method
 ...
 @param childIndex The child index in question
 @param parentIndex The parent index in question
 @return UIColor shown to the left of the label for the child.
 */
