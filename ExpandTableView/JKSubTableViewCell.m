...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.insideTableView.separatorStyle = UITableViewCellSeparatorStyleNone;//UITableViewCellSeparatorStyleSingleLine;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.iconImage setTintColor:[self.delegate iconColourForChildIndex:row underParentIndex:self.parentIndex]];
    [cell setSectionId:[self.delegate idForChildIndex:row underParentIndex:self.parentIndex]];
    ...
    BOOL isRowHighlighted = [self.delegate isHighlightedForChildIndex:row underParentIndex:self.parentIndex];;
    //if(isRowHighlighted)
        [cell highlightCell:isRowHighlighted];
